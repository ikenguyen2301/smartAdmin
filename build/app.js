...
appConfig.serverUrl = 'http://13.92.88.57:3000/';
...
.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $urlRouterProvider.otherwise('/bulkconfig');
          ...
          reader.onload = function(e) {
            ...
            if (attrs.onread) {
              ...
              if (typeof handleRead === "function") {
                handleRead(XLSX.utils.sheet_to_row_object_array(workbook.Sheets[workbook.SheetNames[0]]));
              }
            }
          };
